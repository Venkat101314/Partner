...
import PersonIcon from "../Images/upload.png";
...
const handleUpdate= (e)=>{
  const formData = new FormData();
const URL = `http://192.168.0.132:8001/panelapi/partner/`
  ...
  axios
    .put(`http://192.168.0.132:8001/panelapi/partner/${userId}`, formData, {
      headers: {
        Authorization: `Bearer ${token}`,
         'Content-Type': 'multipart/form-data'
      },
      ...
      renderCell: (params) => {
        return (
          <Grid container xs={12} sx={{ justifyContent: "center" }}>
            <Grid item xs={3}>
              <Button
                onClick={()=> {setOpen(true);updatePartner(params)}}
              >
        ...
        <Items>
          ...
          >
            ...
            <Button
              ...
              onClick={() =>{ setOpen(true);setStatus(true)}}
            >
              Add Partner
            </Button>
          </div>
                      ...
                      >      
                        ...
                        <div className="ms-3">
                          <aside className="mt-2">
                            <ul>{status===true? acceptedFileItems : image}</ul>
